...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        //Construtor para indicar injeção de dependencias
        ...
        public void Seed()
        {
            //Se já existe algum dado na minha db vamos interromeper a operação
            ...
            Seller s4 = new Seller(4, "Matha Red", "matha@gmail.com", new DateTime(1993, 11, 30), 3000.0, d4);
            ...
            //Vamos mandar adicionar esses objetos no banco de dados
